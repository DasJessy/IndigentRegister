...
Partial Class Officer_RegisterApplicant
    ...
    'Protected Sub Wizard1_PreviousButtonClicked(ByVal sender As Object, ByVal e As WizardNavigationEventArgs)
    ...
    '    If e.NextStepIndex > Wizard1.WizardSteps.IndexOf(WizardStep1) Then
    '        'If Not contactsExist Then
    '        '    Popop1.Show()
    '        '    e.Cancel = True
    '        'End If
    '        MsgBox("")
